...
registerBtn = form.querySelector(".btn input"),
...
registerBtn.onclick = () => {
    ...
    xhr.open("POST","./php/register_back.php", true); /* (phương thức HTTP, URL mà ta sẽ gửi yêu cầu, yêu cầu có đồng bộ hay không) */
