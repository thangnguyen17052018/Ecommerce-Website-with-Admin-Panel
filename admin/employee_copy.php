    ...
    <script>
        ...
        $(document).ready(() => {
            ...
            $(document).on('click', 'button[data-role=edit]', (e) => {
                ...
                let id_NV = $('#'+id).children('td[data-target=MSNV]').text();
                let ho_ten = $('#'+id).children('td[data-target=HoTenNV]').text();
                let chuc_vu = $('#'+id).children('td[data-target=ChucVu]').text();
                let dia_chi = $('#'+id).children('td[data-target=DiaChi]').text();
                let sdt = $('#'+id).children('td[data-target=SoDienThoai]').text();
                $('#idNV').val(id_NV);
                $('#fullname').val(ho_ten);
            ...
            $('#save-btn').on('click', () => {
                ...
                $.ajax({
                    ...
                    success: function(response){
                        ...
                        $('#'+id).children('td[data-target=HoTenNV]').text(ho_ten);
                        $('#'+id).children('td[data-target=ChucVu]').text(chuc_vu);
                        $('#'+id).children('td[data-target=DiaChi]').text(dia_chi);
                        $('#'+id).children('td[data-target=SoDienThoai]').text(sdt);
